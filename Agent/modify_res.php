...
<?php
 if(isset($_GET['ID_RES'])) {
    ...
    $id_res = $_GET['ID_RES'];
    $sql="SELECT U.NOM,U.IMAGE_UTIL,U.LOGIN ,U.PRENOM, TC.TYPE_CHAMBRE, TA.TYPE_ACTIVITE, R.NBRE_CHAMBRE, R.DATE_D_ENTREE, R.DATE_SORTIE,R.ID_RES ,TC.ID_TYPE_CHAMBRE ,TA.ID_TYPE_ACTIVITE,C.TYPE
    FROM reservation R
    ...
    <?php if (isset($row)) : ?>
        <fieldset>
            ...
            <form method="post" action="/Agent/update_res.php" onsubmit=" return validateForm()" enctype="multipart/form-data">
                ...
                <input type="text" name="type_chambre" id="type_chambre" 

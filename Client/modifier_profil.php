...
if (isset($_POST['update_profile'])) {
   ...
   $requete=mysqli_query($conn, "UPDATE `utilisateurs` SET NOM = '$update_nom', E_MAIL = '$update_email', PRENOM ='$update_prenom', TELE='$update_tele', LOGIN ='$update_username', CIN='$update_cin', ADRESSE='$update_adresse' WHERE ID_UTILL = '$user_id'") or die('query failed');
   if($requete)
   {
      $isSuccess=true;
   }

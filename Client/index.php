...
<head>
    <meta charset="utf-8">
    <link href="/pageClient/CSS/styles.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/login/styles_connexion.css">
        ...
        <div class="">
            ...
            <nav style="margin-top:35px; ">
                <ul>
                    ...
                    <li>  <a  href="home.php"> <i class="fa-solid fa-user"></i></a></li>
                </ul>
